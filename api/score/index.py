...
# Add parent directory to path to import faa_calculator
sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))

# Import FAA calculator functions from parent directory
try:
    ...
    try:
        ...
        from api.faa_calculator import calculate_faa_scores, get_allocation
